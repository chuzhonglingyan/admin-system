<template>
  <el-dialog :visible.sync="dialog" append-to-body title="执行日志" width="88%">
    ...
    <div class="head-container">
      ...
      />
      <el-select v-model="query.status" placeholder="日志状态" clearable size="small" class="filter-item" style="width: 110px" @change="toQuery">
    ...
    <el-table v-loading="loading" :data="data" style="width: 100%;margin-top: -10px;">
      <el-table-column :show-overflow-tooltip="true" prop="ip" label="执行机器" />
      ...
      <el-table-column prop="createTime" label="异常详情" width="110px">
        <template slot-scope="scope">
          <el-button v-show="scope.row.error" size="mini" type="text" @click="info(scope.row.error)">查看详情</el-button>
        </template>
      </el-table-column>
      <el-table-column :show-overflow-tooltip="true" align="center" prop="taskTimes" width="100px" label="任务耗时(毫秒)" />
